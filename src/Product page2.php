  ...
  <body>
    ...
    <main class="container">
      ...
      <div class="left-column">
        <img data-image="black" src="/img/products/dress3.jpg"  alt="">
        <img data-image="blue" src="/img/products/dress2.jpg" alt="">
        <img data-image="red" class="active" src="/img/products/dress1.jpg" style="width: auto;" alt="">
      </div>
